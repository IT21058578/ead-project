...
const AddAccount = () => {
  return (
    <form action="/" method="post" className="admin-profile p-3 mb-5">
      ...
      <div>
        <a href="#" className="fd-btn w-25 text-center">
          SAVE ACCOUNT
        </a>
      </div>
    </form>
    ...
    <form action="/" method="post" className="admin-profile p-3 mb-5">
      ...
      <div>
        {formState === "disabled" ? (
          <a
            href="#"
            className="fd-btn w-25 text-center rounded-2"
            onClick={activeForm}
          >
            EDIT PROFILE
          </a>
          ...
          <button
            className="fd-btn w-25 text-center rounded-2 border-0"
            type="submit"
          >
            SAVE NOW
          </button>
